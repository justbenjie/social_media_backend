...
SQLALCHEMY_DATABASE_URL = "postgresql://postgres:admin@localhost:5432/social_media_test"
...
def test_user(client):
    user_data = {"email": "iamphilipp@gmail.com",
                 "password": "12345"}
...
def test_user2(client):
    user_data = {"email": "somebody@gmail.com",
